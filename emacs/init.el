...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/OSenv/terminal/configuration.org" "~/OSenv/emacs/configuration.org" "~/orgs/roam/web/finally_we_may_have_a_path_to_the_fundamental_theory_of_physics_and_it_s_beautiful_stephen_wolfram_writings.org" "~/orgs/gtd.org" "~/orgs/code.org" "~/orgs/journal.org"))
